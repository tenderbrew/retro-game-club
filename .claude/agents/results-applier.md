...
- `trophies/trophy-<prior-month>-*.html` — holder list, plus rarity tier + % per the scheme (Legendary ≤10 / Rare 11–20 / Uncommon 21–40 / Common >40; label + `tcase-rarity-*` class + `N of 28 (X%)` stat must agree). Also re-tier any OTHER trophy whose holder count crossed a threshold this month.
